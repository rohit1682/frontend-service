      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center">
          ...
          <select
            ...
            className="bg-white border border-gray-300 rounded px-3 py-1.5 text-sm outline-none focus:ring-2 focus:ring-[#9EF300]"
          >
      ...
      {sortedData.length === 0 ? (
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 flex space-x-6 z-10">
